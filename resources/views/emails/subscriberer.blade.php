...
<h1 style="color:#8412c0;direction:ltr;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:28px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;"><strong>{{$mailerInfo->subject}}</strong></h1>
</td>
</tr>
</table>
...
<p style="text-align: center; line-height: 1.5; word-break: break-word; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 18px; mso-line-height-alt: 27px; margin: 0;"><span style="font-size: 18px; color: #aa67cf;">{{$mailerInfo->message}}</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
